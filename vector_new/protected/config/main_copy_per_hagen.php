...
return array(
	...
	'components'=>array(
		...
		*/
		...
		'db'=>array(
			'connectionString' => 'sqlsrv:server=VECTORDB;database=vector_new',
            'username' => 'sa',
            'password' => 'Vector2013',
            'charset' => 'utf8',
		),
	...
	'params'=>array(
		// this is used in contact page
                'soapUrl' => 'https://winservices-soap.web.cern.ch/winservices-soap/Generic/Authentication.asmx?WSDL',
                'soapLogin' => 'vectauth',
                'soapPassword' => 'Tacuve04',
		'adminEmail'=>'webmaster@example.com',
                'languages'=>array('fr'=>'Français', 'en'=>'English'),
                'dfs'=>'\\\cerndata74\p-vector$',
	),
);