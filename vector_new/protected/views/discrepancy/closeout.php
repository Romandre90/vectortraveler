...
$this->menu = array(
    ...
    array('label' => Yii::t('default', 'Delete Discrepancy'), 'url' => '#', 'linkOptions' => array('submit' => array('delete', 'id' => $model->id), 'confirm' => Yii::t('default', 'Are you sure you want to delete this discrepancy?'))),
);
?>

<h1><?php echo Yii::t('default', 'Close Discrepancy') ?> <?php echo $model->id; ?></h1>
