...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row buttons">
                <?php if($model->isNewRecord){
                    ...
                    echo CHtml::button(Yii::t('default','Cancel'), array('class'=>'cancel','submit' => array('project/index'))); 
                }else{
                    echo CHtml::submitButton(Yii::t('default','Save')); 
                    echo CHtml::button(Yii::t('default','Cancel'), array('class'=>'cancel','submit' => array('project/view','id'=>$model->id))); 
                }?>
	</div>
