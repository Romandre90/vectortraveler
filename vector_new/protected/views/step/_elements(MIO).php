...
foreach ($elements as $element):
    ...
    {
    	/*
    //	echo $element->typeId ."->".$titre." open... " ;
    //	echo "<ul><div class='element'><li>$titre";
    	echo "<ul><div class='element'><li>";
    	if($element->typeId!=6)
    		echo $titre;
    	switch ($element->typeId)
    	{
    		case 0: //echo ($element->typeId)."<br>"; break;
    			...
    			break;
    		case 1: echo($element->typeId)."<br/>"; break;
    		
    		echo "<div class='result' title='pippo'></div><div class='exceltools' style='display:none'><input class='Excel'  type='button' value='Excel Chart' onclick=location.href='#';></br></div>";
    		 	...
    		 	$url=Yii::app()->request->baseUrl."/index.php/step/excelComp/".$issueId."?"."elementId=".$element->id;//funciona
              	if ($element->getResult($issueId) && $issueView)
              	{
            		$e="pippo";
		       		$url="#";
              		echo "<div class='result' title='".$e."'>" . nl2br($e) . "</div><div class='exceltools' style='display:none'><input class='Excel'  type='button' value='Excel Chart' onclick=location.href='".$url."';></br></div>";
    		...
    		case 2:// echo($element->typeId)."<br>"; break;
    		...
    		case 3:// echo($element->typeId)."<br>"; break;
    		...
    		case 4: echo($element->typeId)."<br>"; break;
    		
    		case 5:// echo($element->typeId)."<br>"; break;
    			$url=Yii::app()->request->baseUrl."/index.php/step/excelComp/".$issueId."?"."elementId=".$element->id;//funciona
    			echo "<div title='".$element->getUserDate($issueId)."'>";
    		...
    		case 6: echo($element->typeId)."<br>"; break;
    		
    		case 7:// echo($element->typeId)."<br>"; break;
    			$url=Yii::app()->request->baseUrl."/index.php/step/excelComp/".$issueId."?"."elementId=".$element->id;//funciona
    			echo "<div title='".$element->getUserDate($issueId)."'>";
    		...
    		case 8: echo($element->typeId)."<br>"; break;
    		case 9: echo($element->typeId)."<br>"; break;
    		case 10:// echo($element->typeId)."<br>"; break;
	    		...
	    		break;
    		case 11:// echo($element->typeId)."<br>"; break;
    			echo "<div class='link center'>";
    			if ($element->label) {
    				$label = $element->label;
    			} else {
    			...
    			echo CHtml::link($label, $element->url, array('target' => '_blank')) . "</div>";
    			break;
    		case 12: echo($element->typeId)."<br>"; break;
    		case 13: echo($element->typeId)."<br>"; break;
    		case 14:// echo($element->typeId)."<br>"; break;
	    		$info=false;
	    		$i=0;
	    		$id = $element->id;
